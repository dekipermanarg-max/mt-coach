...
function patchMonitoring() {
  ...
  source = ensureImport(
    source,
    'import { getAdminDone, getAdminPercent, getAdminTotal, getMissingAdmin, isAuviComplete, isLdComplete, isSimpleSession, isSessionAdminComplete } from "../../lib/session-admin";'
  );
