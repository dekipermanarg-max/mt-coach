...
const replacement = [
  ...
  "    });",
  "    const lines: string[] = [",
  "      \"Halo, teman-teman MT! ☀️\",",
  "      \"\",",
  "      \"Terima kasih untuk semangat dan effort teman-teman dalam menjalankan KBM/Klinik PR kemarin. 🙌\",",
  "      \"Apresiasi untuk seluruh MT yang sudah melengkapi seluruh administrasi dengan tepat waktu. 👏✨\",",
  "      \"\",",
  "    ];",
  "    if (!reportIncompleteRows.length) {",
  "      lines.push(\"Keren! Yuk, pertahankan konsistensi dan kedisiplinan ini untuk administrasi di sesi-sesi berikutnya. 💪\", \"\", \"Semangat mengajar hari ini, teman-teman! 💙🔥\");",
  "      return lines.join(\"\\n\");",
  "    }",
  "    lines.push(\"Untuk MT yang administrasinya masih belum lengkap, mohon segera dilengkapi ya agar seluruh pelaksanaan KBM/Klinik PR dapat terpantau dengan baik.\", \"\", \"🔎 *Yang masih perlu dilengkapi:*\", \"\");",
  "    let number = 1;",
  ...
  "      });",
  "    });",
  "    lines.push(\"Jika sudah selesai, mohon berikan reaksi ✅ pada pesan ini sebagai konfirmasi.\", \"\");",
  "    lines.push(\"Terima kasih atas kerja sama dan komitmennya. Semangat menjalani hari ini! 💙\");",
  "    return lines.join(\"\\n\");",
