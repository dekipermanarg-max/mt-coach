...
export default function Home() {
  ...
  const selectedBranchName = branch === "all" ? null : branchesList.find(b => b.id === branch)?.name || null;
  const ldGoal = branch === "all"
    ? getLDWeeklyTargetForBranches(branchesList.map(b => b.name).filter(name => getBranchTargetKey(name)))
    : getLDWeeklyTarget(selectedBranchName || "");
  const ldRombels = countUniqueLDRombels(visibleSessions);
