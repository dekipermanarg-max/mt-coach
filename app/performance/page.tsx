...
export default function Performance() {
  ...
  return <div className="performance-shell"><main className="performance-main"><div className="performance-wrap">
    <section className="planning-hero"><div className="planning-hero-row"><div><div className="eyebrow">MT COACH · ANALYTICS</div><h1>MT Performance</h1><p>Ranking MT berdasarkan konsistensi kelengkapan administrasi sesi Finalized.</p></div><span className="badge planning-status">🏆 Ranking Admin</span></div></section>
