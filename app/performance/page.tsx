  ...
  return (
    <div className="performance-shell">
      <header className="performance-topbar">
        <div className="performance-brand">MT Coach <span>BAC · Internal</span></div>
