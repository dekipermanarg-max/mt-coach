...
export default function Monitoring() {
  ...
  async function load() {
    ...
    else setRows((data || []) as MonitoringRow[]);
    setLoading(false);
  }
  ...
  ), [rows, mts, rombels, mapels, branchId, selectedMT, search]);
