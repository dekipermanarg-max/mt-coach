...
export default function NavigationSecure() {
  ...
  return <>
    <nav className="app-nav" aria-label="Menu utama"><div className="app-nav-inner">
      ...
      <div className="app-user-box"><div className="app-user-copy"><strong>{profile.display_name}</strong><span>{profile.role}</span></div><button type="button" className="app-logout" onClick={() => void signOut()}>Keluar</button></div>
    </div></nav>
    <style jsx global>{`
